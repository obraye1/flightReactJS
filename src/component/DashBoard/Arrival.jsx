    ...
    const fetchData = async () => {
      try {
        ...
        const flights = data.map((flight) => {
          const { icao24, callsign, firstSeen, lastSeen, estArrivalAirport } =
            flight;
